export const THEMES = {
  ...
  Bubblegum: {
    ...
    dark: {
      ...
      "shadow-sm": "3px 3px 0px 0px hsl(206.1538 28.0576% 27.2549% / 1), 3px 1px 2px -1px hsl(206.1538 28.0576% 27.2549% / 1)",
      "shadow": "3px 3px 0px 0px hsl(206.1538 28.0576% 27.2549% / 1), 3px 1px 2px -1px hsl(206.1538 28.0576% 27.2549% / 1)",
      "shadow-md": "3px 3px 0px 0px hsl(206.1538 28.0576% 27.2549% / 1), 3px 2px 4px -1px hsl(206.1538 28.0576% 27.2549% / 1)",
      "shadow-lg": "3px 3px 0px 0px hsl(206.1538 28.0576% 27.2549% / 1), 3px 4px 6px -1px hsl(206.1538 28.0576% 27.2549% / 1)",
      "shadow-xl": "3px 3px 0px 0px hsl(206.1538 28.0576% 27.2549% / 1), 3px 8px 10px -1px hsl(206.1538 28.0576% 27.2549% / 1)",
  ...
  MochaMousse: {
    ...
    dark: {
      ...
      "destructive-foreground": "okllch(0.2721 0.0141 48.1783)",
  ...
  RetroArcade: {
    light: {
      ...
      "shadow-2xl": 
        "2px 2px 4px 0px hsl(196 83% 10% / 0.38)",
  ...
  SageGarden: {
    ...
    dark: {
      ...
      "shadow-2xl":
        "0px 1px 2px 0px hsl(0 0% 0% / 0.10)",
  ...
  Supabase: {
    light: {
      ...
      "shadow-2xl":
        "0px 1px 3px 0px hsl(0 0% 0% / 0.43)",
  ...
  Twitter: {
    light: {
      ...
      "shadow-2xs": "0px 2px 0px hsl(202.8169 89.1213% 53.1373% / 0)",
      "shadow-xs": "0px 2px 0px hsl(202.8169 89.1213% 53.1373% / 0)",
      "shadow-sm":
        "0px 2px 0px hsl(202.8169 89.1213% 53.1373% / 0), 0px 1px 2px -1px hsl(202.8169 89.1213% 53.1373% / 0)",
      shadow:
        "0px 2px 0px hsl(202.8169 89.1213% 53.1373% / 0), 0px 1px 2px -1px hsl(202.8169 89.1213% 53.1373% / 0)",
      "shadow-md":
        "0px 2px 0px hsl(202.8169 89.1213% 53.1373% / 0), 0px 2px 4px -1px hsl(202.8169 89.1213% 53.1373% / 0)",
      "shadow-lg":
        "0px 2px 0px hsl(202.8169 89.1213% 53.1373% / 0), 0px 4px 6px -1px hsl(202.8169 89.1213% 53.1373% / 0)",
      "shadow-xl":
        "0px 2px 0px hsl(202.8169 89.1213% 53.1373% / 0), 0px 8px 10px -1px hsl(202.8169 89.1213% 53.1373% / 0)",
      "shadow-2xl": "0px 2px 0px hsl(202.8169 89.1213% 53.1373% / 0)",
